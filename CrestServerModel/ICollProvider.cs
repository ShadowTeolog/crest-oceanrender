...
namespace CrestServer
{
    ...
    public interface ICollProvider
    {
        ...
        /// </summary>
        bool SampleDisplacement(ref Vector3 i_worldPos, SamplingData i_samplingData,float time, out Vector3 o_displacement);
        void SampleDisplacementVel(ref Vector3 i_worldPos, SamplingData i_samplingData,float time, out Vector3 o_displacement, out bool o_displacementValid, out Vector3 o_displacementVel, out bool o_velValid);

        /// <summary>
        /// Samples ocean surface height at given world position.
        /// </summary>
        bool SampleHeight(ref Vector3 i_worldPos, SamplingData i_samplingData,float time, out float o_height);

        /// <summary>
        /// Sample ocean normal at an undisplaced world position.
        /// </summary>
        bool SampleNormal(ref Vector3 i_undisplacedWorldPos, SamplingData i_samplingData,float time, out Vector3 o_normal);

        /// <summary>
        /// Computes the position which will be displaced to the given world position.
        /// </summary>
        bool ComputeUndisplacedPosition(ref Vector3 i_worldPos, SamplingData i_samplingData,float time, out Vector3 undisplacedWorldPos);
